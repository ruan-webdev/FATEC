function correctVer(p_variaveis, p_restricoes){
...
function calcMatriz(p_matriz) {
	...
	// Escolhendo qual variável básica entra
...
function criarForm(p_variaveis, p_restricoes) {
		...
		if (p_variaveis > 0 && p_restricoes > 0) {
			...
			document.getElementById("aqui").innerHTML+="<input type='number' class='inputZ' required autocomplete='off' size='5' maxlength='10' step='0.1' id='y1' name='y1' 'style=width:50px;'  /> x<sub>1</sub>";
			for (var h = 2; h <= p_variaveis; h++) {
				document.getElementById("aqui").innerHTML+=" + <input type='number' class='inputZ' required autocomplete='off' size='5' maxlength='10' step='0.1' id='y"+h+"' name='y"+h+"' />x<sub>"+h+"</sub> <br><br>";
			}
			for (var i = 1; i <= p_restricoes; i++) {
				document.getElementById("aqui").innerHTML+="<p><b>Restrição "+i+"</b></p>";
				document.getElementById("aqui").innerHTML+="<input type='number' class='input' required autocomplete='off' size='5' maxlength='10' step='0.1' id='x"+i+"1' name='x"+i+"1' 'style=width:50px;' /> x<sub>1</sub>";
				...
				+"<input type='number' class='input' required size='5' maxlength='10' id='b"+i+"' name='b"+i+"' style='text-align:left' /> <br><br>";
			}
			document.getElementById("aqui").innerHTML+="<br><p><b>Restrição "+(++p_restricoes)+"</b></p>"
			+"<p>x<sub>i</sub> >= 0</p> ";
...
function printTabela(p_matriz) {
	...
	if(document.getElementById("minimizar").checked==true){
		var variaveis = (parseInt(document.form1.variaveis.value)*-1);
	}else{
